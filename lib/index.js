...
module.exports = function (_EventEmitter) {
  ...
  function Umzug() {
    ...
    _classCallCheck(this, Umzug);

    var _this = _possibleConstructorReturn(this, (Umzug.__proto__ || Object.getPrototypeOf(Umzug)).call(this));
    ...
    _this.options.migrations = _extends({
      params: [],
